...
function library:CreateSettingsTab(menu)
    ...
    creditsSection:AddText({text = "syhook"})
    creditsSection:AddText({text = "libmant"})
    ...
    mainSection:AddBind({text = 'Menu', flag = 'togglebind', nomouse = true, noindicator = true, bind = Enum.KeyCode.RightShift, callback = function()
